                                        ...
                                        <div className="card-body ps-4 pe-4 text-black">
                                            <form>
                                                ...
                                                <div className="form-outline mb-4">
                                                    <label className="form-label" htmlFor="form2Example17">Enter Your Email</label>
                                                    <input type="email" id="form2Example17" className="form-control form-control-lg" placeholder="" />
                                                </div>
                                                ...
                                                <p style={{ color: '#393f81', textAlign: 'center' }}>
                                                    <Link to="/login" style={{ color: '#7367f0', textDecoration: 'none', fontWeight: 'bold' }}>  Back to log in</Link>
                                                </p>
                                            </form>
                                        </div>
                                    </div>
